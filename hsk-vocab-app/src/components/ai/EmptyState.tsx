        ...
        <div className="grid grid-cols-2 gap-1.5 sm:gap-2 w-full max-w-md mb-3">
          {quickActions.map((action) => (
            <button
              ...
              className="flex flex-col items-center gap-1 px-2.5 py-2 sm:py-2.5 rounded-xl text-[10px] sm:text-xs font-medium bg-purple-50/80 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all border border-purple-200/50 dark:border-purple-700/30"
            >
        ...
        <div className="flex flex-wrap gap-1.5 sm:gap-2 justify-center max-w-md">
          {suggestions.map((s) => (
            <button
              ...
              className="px-2.5 sm:px-3 py-1.5 rounded-xl text-[10px] sm:text-xs font-medium bg-ink-50 dark:bg-white/5 text-ink-600 dark:text-ink-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:text-purple-600 dark:hover:text-purple-400 transition-all border border-ink-100/50 dark:border-white/5"
            >
              {s}
            </button>
          ))}
  ...
  if (mode === 'conversation') {
    return (
      <div className="flex flex-col items-center text-center px-3 sm:px-4 py-3 sm:py-4">
        ...
        >
          <ModeIcon className="w-5 h-5 sm:w-6 sm:h-6 text-pink-500" />
        </motion.div>
        <h2 className="text-sm sm:text-base font-bold text-ink-900 dark:text-white mb-1">
          {modeConfig.emptyTitle}
        </h2>
